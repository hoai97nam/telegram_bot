...
chromedriver_path = 'C:/Users/nhnam/Downloads/chromedriver.exe' # Change this to your own chromedriver path!
...
username.send_keys('nhnam97')
password = webdriver.find_element_by_name('password')
password.send_keys('nguyenhnam')

#button_login = webdriver.find_element_by_xpath('//*[@id="react-root"]/section/main/div\
...
prev_user_list = pd.read_csv('20200606-164028_users_followed_list', delimiter=',').iloc[:,1:2] # useful to build a user log
